...
function App() {
  ...
  const claimNFTs = () => {
    if(tokens <= CONFIG.freetokens){
      let cost = (tokens-CONFIG.freetokens) * CONFIG.DISPLAY_COST;
  ...
  const decrementtokens = () => {
    ...
    if (newtokens < CONFIG.freetokens) {
      newtokens = CONFIG.freetokens;
    }
    settokens(newtokens);
  };
